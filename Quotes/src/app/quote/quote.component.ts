...
export class QuoteComponent implements OnInit {
  ...
  Quotes=[
    ...
    new Quote(3,'The purpose of life is not to be happy. It is to be useful, to be honorable, to be compassionate, to have it make some difference that you have lived and lived well.','~ Ralph Waldo Emerson',new Date(2019,10,14)), 
